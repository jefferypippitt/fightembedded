...
export const metadata: Metadata = {
  ...
  description: "Usage guidelines for Fight Embedded.",
};
    ...
    <article className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          by the terms and provision of this agreement. This website is a
          personal project for informational purposes only.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          for commercial purposes without prior written consent from me.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          UFC® and all related athlete images, event names, and promotional
          materials are trademarks owned by UFC®. This website is an independent
          fan project and is not affiliated with or endorsed by UFC®.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          purposes only. I make no representations or warranties about the
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          I reserve the right to modify these terms at any time without prior
