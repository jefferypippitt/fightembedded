...
export async function getDashboardStats() {
  ...
  const formattedMostFollowedAthlete = mostFollowedAthlete ? {
    ...mostFollowedAthlete,
    winRate: mostFollowedAthlete.wins + mostFollowedAthlete.losses > 0
      ? ((mostFollowedAthlete.wins / (mostFollowedAthlete.wins + mostFollowedAthlete.losses)) * 100).toFixed(1)
      : '0.0'
  } : null;
