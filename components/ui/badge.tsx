  ...
  "inline-flex items-center justify-center rounded-md px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 transition-all duration-200 overflow-hidden relative",
  {
    variants: {
      variant: {
        ...
        nr: "border border-muted/40 bg-muted/20 text-muted-foreground hover:bg-muted/30 hover:border-muted/50 dark:bg-muted/30 dark:border-muted/50 dark:hover:bg-muted/40 font-mono",
        champion:
          "border border-yellow-400/40 bg-yellow-50 text-yellow-700 dark:text-yellow-300 dark:border-yellow-600/30 dark:bg-yellow-900/30 font-semibold shadow-sm font-mono",
        retired:
